        ...
        try
        {
            ...
            foreach (var ledger in ledgers)
            {
                var ledgerDisplay = new LedgerDisplay
                {
                    ...
                    Amount = Math.Round(ledger.Amount, 6).ToString("0.######"),
                    Fee = ledger.Fee.ToString(),
                    Balance = Math.Round(ledger.Balance, 6).ToString("0.######")
                };
                ...
                if (asset is not null)
                {
                    ...
                    var currencySymbol = CurrencyCodeMapper.GetSymbol(ledger.Asset);
